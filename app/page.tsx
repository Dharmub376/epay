    ...
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-rose-50 via-white to-amber-50 px-4 py-10">
      <Card className="flex w-full max-w-sm flex-col items-stretch justify-between gap-4 rounded-2xl border-red-200 bg-white/95 p-5 text-center shadow-xl shadow-red-100 backdrop-blur-sm sm:max-w-[8.5cm]">
        <CardHeader className="w-full p-0">
          <div className="relative mx-auto flex h-40 w-full items-center justify-center overflow-hidden rounded-2xl border border-red-100 bg-gradient-to-b from-white via-red-50 to-white sm:h-44">
            <Image
              src="/product.png"
              alt="Harpic"
              width={320}
